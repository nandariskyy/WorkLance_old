    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between h-20 items-center">
        ...
        <div class="hidden md:flex items-center gap-3">
          ...
          <a href="pesanan.php" class="px-5 py-2.5 text-sm font-bold text-dark hover:text-accent transition-colors border border-gray-200 hover:border-accent rounded-full bg-white/60 hover:bg-accent/5 flex items-center gap-2">
